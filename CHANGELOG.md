...
## [v1.2.6](https://github.com/shogo82148/cloudwatch-logs-agent-lite/compare/v1.2.5...v1.2.6) - 2026-07-23
...
- build(deps): add CodeQL actions group to dependabot configuration by @shogo82148 in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/654
- build(deps): bump aws-actions/configure-aws-credentials from 6.2.0 to 6.2.1 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/647
- build(deps): bump the codeql-actions group with 3 updates by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/655
- build(deps): bump aws-actions/configure-aws-credentials from 6.2.1 to 6.2.2 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/657
- build(deps): bump the aws-sdk group with 2 updates by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/656
- build(deps): bump the codeql-actions group with 3 updates by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/658
- build(deps): bump github.com/aws/aws-sdk-go-v2/config from 1.32.28 to 1.32.29 in the aws-sdk group by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/659
- build(deps): bump the aws-sdk group with 2 updates by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/660
- build(deps): bump Songmu/tagpr from 1.20.0 to 1.20.1 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/661
- build(deps): bump actions/setup-go from 6.5.0 to 7.0.0 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/662
- build(deps): bump the codeql-actions group with 3 updates by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/663
- build(deps): bump actions/checkout from 7.0.0 to 7.0.1 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/664
- build(deps): bump reviewdog/action-actionlint from 1.72.0 to 1.73.0 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/666
- build(deps): bump the codeql-actions group with 3 updates by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/665
- build(deps): bump the aws-sdk group with 4 updates by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/667
- build(deps): bump aws-actions/configure-aws-credentials from 6.2.2 to 6.2.3 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/669
- build(deps): bump the codeql-actions group with 3 updates by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/668
...
- build(deps): bump the aws-sdk group with 4 updates by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/574
- build(deps): bump github/codeql-action from 4.31.6 to 4.31.10 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/580
- build(deps): bump actions/setup-go from 6.1.0 to 6.2.0 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/581
- build(deps): bump Songmu/tagpr from 1.9.0 to 1.11.1 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/582
- build(deps): bump github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs from 1.62.0 to 1.65.0 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/590
- build(deps): bump actions/checkout from 6.0.1 to 6.0.2 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/584
- build(deps): bump Songmu/tagpr from 1.11.1 to 1.18.1 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/593
- build(deps): bump actions/setup-go from 6.2.0 to 6.4.0 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/594
- build(deps): bump shogo82148/actions-github-app-token from 1.1.0 to 1.2.0 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/596
- build(deps): bump reviewdog/action-golangci-lint from 2.8.0 to 2.10.0 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/597
- build(deps): bump reviewdog/action-actionlint from 1.69.1 to 1.72.0 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/599
- build(deps): bump shogo82148/actions-goveralls from 1.10.0 to 1.11.0 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/598
- build(deps): bump goreleaser/goreleaser-action from 6.4.0 to 7.0.0 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/588
- build(deps): bump the aws-sdk group across 1 directory with 3 updates by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/592
- migrate AWS native OIDC federation by @shogo82148 in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/601
- bump Go 1.26.2 by @shogo82148 in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/600
- bump github/codeql-action v4.35.1 by @shogo82148 in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/602
- add support for AlmaLinux 10 and Rocky Linux 10 by @shogo82148 in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/603
- drop support of Amazon Linux 2 and CentOS 7 by @shogo82148 in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/604
...
- build(deps): bump reviewdog/action-actionlint from 1.68.0 to 1.69.0 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/566
- build(deps): bump the aws-sdk group with 4 updates by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/557
- build(deps): bump actions/setup-go from 6.0.0 to 6.1.0 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/563
- build(deps): bump actions/checkout from 5.0.0 to 6.0.0 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/564
- build(deps): bump github/codeql-action from 4.30.8 to 4.31.5 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/565
...
- Bump the aws-sdk group with 2 updates by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/504
...
## [v1.0.1](https://github.com/shogo82148/cloudwatch-logs-agent-lite/compare/v1.0.0...v1.0.1) - 2024-03-22
...
- Bump github.com/aws/aws-sdk-go-v2/config from 1.18.13 to 1.18.14 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/338
...
- Bump the aws-sdk group with 3 updates by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/382
...
- Bump the aws-sdk group with 3 updates by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/416
...
## [v1.0.0](https://github.com/shogo82148/cloudwatch-logs-agent-lite/compare/v0.0.17...v1.0.0) - 2022-11-09
...
- Bump github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs from 1.15.21 to 1.15.22 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/287
...
- Bump github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs from 1.15.7 to 1.15.8 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/223
...
- Bump github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs from 1.12.0 to 1.13.0 by @dependabot[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/174
...
## [v0.0.14](https://github.com/shogo82148/cloudwatch-logs-agent-lite/compare/v0.0.13...v0.0.14) - 2021-10-22
...
- fix updating LastFlushedTime by @shogo82148 in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/122
...
- Improve buffering by @shogo82148 in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/84
...
## [v0.0.6](https://github.com/shogo82148/cloudwatch-logs-agent-lite/compare/v0.0.5...v0.0.6) - 2020-10-28
...
- Bump github.com/stretchr/testify from 1.6.0 to 1.6.1 by @dependabot-preview[bot] in https://github.com/shogo82148/cloudwatch-logs-agent-lite/pull/25
